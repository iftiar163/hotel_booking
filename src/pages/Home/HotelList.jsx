		...
		<>
			<section className="hotel-list-section">
				<div className="hotel-wrapper">
					{/* Hotel List Heading */}
					<div className="hotel-list-heading w-[1280px] mx-auto flex flex-col justify-center items-center gap-3">
					...
					<div className="hotel-list-items my-20 w-[1280px] mx-auto grid lg:grid-cols-3  md:grid-cols-2 sm:grid-cols-1 gap-8">
